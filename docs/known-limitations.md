...
## Gastrectomy and ileal resection boundaries

* Partial and total gastrectomy are distinct qualitative states, but the calculator has no validated meal-level B12 or iron coefficient, passive-diffusion dose model, reconstruction adjustment, time-since-surgery curve, residual-stomach measure, or personalized modeled requirement.
* Gastrectomy B12 output distinguishes food-bound release, free/crystalline B12, intrinsic-factor-dependent handling, and pharmacologic-dose passive diffusion conceptually. It does not diagnose intrinsic-factor status or prescribe high-dose supplementation.
