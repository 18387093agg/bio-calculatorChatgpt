...
insert into model_assumptions(model_key,description,formula,parameters_json,conditions_json,limitations,status,evidence_id,classification,confidence,enabled) values
 ...
 ('iron.nonheme.low_acid.v1','Low-acid sensitivity mechanism',null,'{}','{"gastric_acid":["low","absent"],"form":"nonheme"}','Mechanism is qualitatively supported, but no defensible numeric multiplier was established.','unsupported','project-audit-2026','F','low',false),
 ...
 ('b12.food_bound.low_acid.v1','Food-bound gastric release mechanism',null,'{}','{"gastric_acid":["low","absent"],"food_bound":true}','Mechanism is qualitatively supported, but no defensible numeric multiplier was established; free/crystalline B12 is excluded.','unsupported','project-audit-2026','F','low',false),
